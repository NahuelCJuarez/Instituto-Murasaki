    ...
    <div className={styles.homepage}>
      ...
      <div id="intro" className={styles.sectionContainer}>
        <div className={styles.intro}>
          ...
          <p>
            ¡Participa de las clases online, desde la comodidad de tu hogar!
          </p>
          <p>
            Horarios de clases flexibles y profesores que se ajustan a tus
            necesidades
          </p>
        </div>
      ...
      <div className={styles.sectionsBackground}>
        <div id="manga" className={styles.sectionContainer}>
          <div className={styles.manga}>
            ...
            <p>
              ¡Podes practicar y poner a prueba tu aprendizaje con tus series y
              pasatiempos favoritos, en su idioma nativo!
            </p>
          </div>
      ...
      <div className={styles.cardsContainer}>
        <div id="Nivel" className={styles.card}>
          ...
          <div className={styles.textCardBlack}>
            <h2>Nivel oficial</h2>
            <p>
              Te preparamos para que puedas rendir tus examenes de nivel y
              validar tus conocimientos
            </p>
          </div>
        </div>
        <div id="Turismo" className={styles.card}>
          ...
          <div className={styles.textCardMura}>
            ...
            <p>
              Aprender japonés te abre las puertas a hacer turismo en ese
              hermoso pais, o incluso trabajar en el
            </p>
          </div>
        </div>
        <div id="Discord" className={styles.card}>
          ...
          <div className={styles.textCardBlack}>
            ...
            <p>
              Todas las clases se dan a traves de Discord. Una vez registrado en
              la página, podrás acceder al tutorial para crear tu cuenta e
      ...
      <div id="register" className={styles.registerContainer}>
        <div id="register text container" className={styles.regTextContainer}>
          <h2>¡Crea tu cuenta!</h2>
          <p>
            Regístrate en el instituto y comienza tus clases de forma cómoda y
            rápida haciendo click en el botón
          </p>
        </div>
          <Link
            to="/Register"
